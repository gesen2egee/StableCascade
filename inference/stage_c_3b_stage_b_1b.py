...
caption = "anime 1girl solo smile naughty face"
...
with torch.no_grad(), torch.cuda.amp.autocast(dtype=torch.bfloat16):
    ...
    show_images(preview_c, "output/stage_c_3b_stage_b_1b_preview_c.png")
...
show_images(sampled, "output/stage_c_3b_stage_b_1b_sampled.png")